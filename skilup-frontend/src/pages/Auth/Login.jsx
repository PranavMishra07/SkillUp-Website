...
//       // Optionally decode the JWT to get role (or fetch it separately)
//       const tokenPayload = JSON.parse(atob(access.split(".")[1]));
//       const userRole = tokenPayload.role; // Assuming backend sends 'role' in payload

//       loginUser(access,role);
